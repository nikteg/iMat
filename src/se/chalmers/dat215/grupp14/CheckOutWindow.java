	...
	public void propertyChange(PropertyChangeEvent evt) {
		...
		if (evt.getPropertyName() == "order_place") {
			...
			if (!errors.isEmpty()) {
				...
				if (errors.contains("firstname_invalid"))       msg += "Förnamn saknas\n";
				if (errors.contains("lastname_invalid"))        msg += "Efternamn saknas\n";
				if (errors.contains("address_invalid"))         msg += "Address saknas\n";
				if (errors.contains("mobilephone_invalid"))     msg += "Fel format på mobilnummer\n";
				if (errors.contains("phone_invalid"))           msg += "Fel format på telefonnummer\n";
				if (errors.contains("postaddress_invalid"))     msg += "Postadress saknas\n";
				if (errors.contains("postcode_invalid"))        msg += "Postadress saknas\n";
				if (errors.contains("cardnumber_invalid"))      msg += "Fel format på kortnummer\n";
				if (errors.contains("cvc_invalid"))             msg += "Fel format på cvc\n";
				if (errors.contains("month_invalid"))           msg += "Utgångsmånad saknas\n";
				if (errors.contains("year_invalid"))            msg += "Utgångsår saknas\n";
